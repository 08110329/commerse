    ...
    <div className="flex flex-col gap-8 container bg-gray-50 h-fit">
      ...
      <div className="flex gap-5 px-6">
        <div className="flex flex-col flex-1 gap-6">
          ...
          <div className="flex flex-col flex-1 h-fit bg-white px-6 py-6 rounded-3xl gap-4 text-black">
          ...
          <div className="flex flex-1 h-fit bg-white px-6 py-6 rounded-3xl gap-4 text-black">
            <div className="flex-1 grid gap-2">
              ...
              <input
                ...
                value={pprice}
                onChange={(event) => setPprice(parseFloat(event.target.value))}
              ></input>
            </div>
            <div className="flex-1 grid gap-2">
        ...
        <div className="flex-1 grid gap-5">
          ...
          <div className="flex flex-col bg-white gap-5 text-black rounded-3xl border px-6 py-6 h-fit ">
            <h1>Хэмжээ сонгох</h1>
            <div className="flex flex-col gap-2">
              {numberss.map((number) => (
