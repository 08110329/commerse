          ...
          <div className="flex gap-5 px-6">
              ...
              <div className="flex flex-col flex-1 h-full bg-white px-6 py-6 rounded-3xl gap-4 text-black">
                ...
                <div className="grid grid-cols-4 grid-rows-1 w-full h-[125px] gap-2">
                  <div className="border border-dashed flex justify-center items-center rounded-xl"><AiOutlinePicture className="w-6 h-6"/></div>
                  <div className="border border-dashed flex justify-center items-center rounded-xl"><AiOutlinePicture className="w-6 h-6"/></div>
                  <div className="border border-dashed flex justify-center items-center rounded-xl"><AiOutlinePicture className="w-6 h-6"/></div>
                  <div className=" flex justify-center items-center"><GrAddCircle className="w-6 h-6"/></div>
                </div>
              </div>
              <div className="flex flex-1 h-full bg-white px-6 py-6 rounded-3xl gap-4 text-black">
                <div className="flex-1">
                  <h1>Үндсэн үнэ</h1>
                  <input placeholder="Үндсэн үнэ" className="border w-full px-4 py-2 rounded-md bg-gray-100"></input>
                </div>
                <div className="flex-1">
                  <h1>Үлдэгдэл тоо ширхэг</h1>
                  <input placeholder="Үлдэгдэл тоо ширхэг" className="border w-full px-4 py-2 rounded-md bg-gray-100"></input>
                </div>
              </div>
              </div>
